...
- Консолидация `11 -> 13` вынесена в отдельный helper `public.transact_group_to_allocation_fallback(...)`, потому что это many-to-one операция, а не обычное процентное распределение одной суммы.
