...
- Введён общий сценарный config-слой:
...
- Отдельно доменно пересмотреть связку `invest_*_report -> Н.З.`:
  сейчас это временная каноническая target-leaf модель для миграции, но по бизнес-смыслу инвестиции и `Н.З.` ещё нужно развести или явно подтвердить как одну сущность.
